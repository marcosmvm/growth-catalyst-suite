...
const phases = [{
  ...
  activities: ["Deep-dive into your Ideal Customer Profile (ICP)", "Audit current outbound efforts and results", "Define success metrics and KPIs", "Analyze competitor positioning", "Map decision-maker personas and pain points"],
  ...
  activities: ["Set up dedicated sending domains", "Configure email warming and deliverability", "Connect CRM and lead handoff systems", "Build tracking and reporting dashboards", "Create lead qualification workflows"],
  ...
  activities: ["Build targeted prospect lists using Apollo & enrichment tools", "Write personalized cold email sequences", "A/B test subject lines and messaging", "Launch multi-touch campaigns", "Monitor deliverability and engagement daily"],
  ...
  activities: ["Weekly performance analysis and optimization", "Refine targeting based on reply patterns", "Improve messaging using sales team feedback", "Scale successful segments and campaigns", "Add new markets and ICPs as results prove out"],
