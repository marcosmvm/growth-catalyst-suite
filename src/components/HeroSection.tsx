        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto pt-12 md:pt-24">
            ...
            ease: [0.25, 0.1, 0.25, 1]
              ...
              {["White-glove onboarding", "Enterprise-grade security", "Dedicated success manager"].map(item => <div key={item} className="flex items-center gap-2">
            ...
            ease: [0.25, 0.1, 0.25, 1]
              ...
              <div className="relative rounded-2xl overflow-hidden gradient-border">
                ...
                <img src={heroImage} alt="Advanced AI outreach platform dashboard" className="w-full h-auto rounded-2xl relative z-10" />
